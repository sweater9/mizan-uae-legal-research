...
laws.push(
  {
    number:"CBUAE C 2/2026",
    title:"Small to Medium Sized Enterprises (SME) — Customer Protection Regulation",
    jurisdiction:"Federal",
    authority:"Central Bank of the UAE",
    status:"In force — effective 13 Sep 2026",
    summary:"Establishes the CBUAE customer-protection framework for SME customers of banks and finance companies, covering governance, responsible conduct and financing, disclosure, customer data protection, complaints and support for customers in financial difficulty.",
    relevance:"Material for banks and finance companies providing financial products or services to SME customers. This Regulation is now in force and replaces the 2021 SME Market Conduct Regulation.",
    topics:"cbuae central bank sme small medium enterprise customer protection bank finance company market conduct responsible financing disclosure customer data complaints governance sales conduct",
    source:"https://rulebook.centralbank.ae/en/rulebook/small-medium-sized-enterprises-sme-customer-protection-regulation",
    note:"Effective 13 September 2026 and now operative. It cancels and replaces CBUAE Circular No. 1/2021, the SME Market Conduct Regulation."
  },
  {
    number:"CBUAE C 1/2026",
