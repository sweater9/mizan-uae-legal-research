...
laws.push(
  {
    number:"CBUAE C 4/2026",
    title:"Insurance Company Licensing Regulation",
    jurisdiction:"Federal",
    authority:"Central Bank of the UAE",
    status:"In force — effective 14 Aug 2026",
    summary:"Establishes the current CBUAE licensing and registration framework for insurance companies, including branches of foreign insurance companies, and rules for opening branches and subsidiaries within and outside the UAE.",
    relevance:"Material for insurers, reinsurers and Takaful insurers that are applying for, maintaining or changing a UAE insurance licence or registration, and for insurance groups opening or relocating branches or subsidiaries.",
    topics:"cbuae central bank insurance licensing licence registration insurer reinsurer takaful foreign insurance company branch subsidiary authorised individual fit proper insurance company licensing regulation c4 2026",
    source:"https://rulebook.centralbank.ae/en/entiresection/60",
    note:"Effective 14 August 2026. Article 9.1 states that this Regulation repeals and replaces Insurance Authority Board of Directors’ Resolution No. 2 of 2009 dated 31 January 2010."
  },
  {
    number:"CBUAE C 5/2026",
    title:"Remuneration Regulation for Banks and Insurance Companies",
    jurisdiction:"Federal",
    authority:"Central Bank of the UAE",
    status:"In force — effective 14 Apr 2026",
    summary:"Sets minimum CBUAE requirements for risk-sensitive remuneration frameworks across banks and insurance companies, including governance, Board oversight, fixed and variable remuneration, malus and clawback, Material Risk Takers, control functions and disclosure.",
    relevance:"Material for UAE banks and insurance companies because remuneration policies, performance measures, contracts, governance and risk adjustment must align with the Regulation. It also imposes assessment, remediation and full-compliance transition requirements.",
    topics:"cbuae central bank remuneration bank insurance company compensation bonus variable remuneration fixed remuneration clawback malus material risk taker mrt board remuneration committee governance conduct risk c5 2026",
    source:"https://rulebook.centralbank.ae/en/entiresection/48",
    note:"Effective 14 April 2026. Article 18 requires an assessment of existing remuneration frameworks and a report to the CBUAE within 180 days of the effective date; full compliance is required within 15 months unless the CBUAE grants an extension."
  },
  {
    number:"CBUAE — Regulation Regarding Takaful Insurance (2026)",
  ...
  },
  {
    ...
    title:"Standard Re the Operational Model of Takaful Insurance",
    jurisdiction:"Federal",
    authority:"Central Bank of the UAE",
    status:"Made — effective 15 Jul 2027",
    summary:"Sets minimum requirements for the operational model of Takaful insurance, including the Fund Charter, segregation of accounts, underwriting, investments, re-takaful, claims, surplus, deficits and the Wakala-based operating model.",
  ...
  },
  {
    ...
    title:"Standard of Shari’ah and Procedural Requirements for Agency (Wakala) in Takaful Insurance",
    jurisdiction:"Federal",
    authority:"Central Bank of the UAE",
    status:"Made — effective 15 Jul 2027",
    summary:"Sets Shari’ah and procedural requirements for the Wakala agency model used in Takaful insurance under the CBUAE framework.",
  ...
  },
  {
    ...
    title:"Standard Re Controls and Procedures Establishing Takaful Insurance Fund",
    jurisdiction:"Federal",
    authority:"Central Bank of the UAE",
    status:"Made — effective 15 Jul 2027",
    summary:"Sets minimum controls and procedures for establishing and governing a Takaful Insurance Fund with independent legal personality and financial liability distinct from the Takaful insurance company.",
